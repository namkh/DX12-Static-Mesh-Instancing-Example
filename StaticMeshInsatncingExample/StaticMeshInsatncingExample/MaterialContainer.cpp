...
void ExampleMaterialCreateCode::CreateExampleMaterial(CommandBufferBase* cmdBuffer, ExampleMaterialType type, SimpleMaterial* mat)
{
	switch (type)
	{
		case ExampleMaterialType::EXAMPLE_MAT_HARDWARE_INSTANCING1 :
			{
				std::wstring filePath = L"../Resources/Textures/tex1.dds";
				mat->m_diffuseTex = gTexContainer.CreateTexture(cmdBuffer, filePath);
				
			}
			break;

		case ExampleMaterialType::EXAMPLE_MAT_HARDWARE_INSTANCING2:
			{
				std::wstring filePath = L"../Resources/Textures/tex2.dds";
				mat->m_diffuseTex = gTexContainer.CreateTexture(cmdBuffer, filePath);
			}	
			break;

		case ExampleMaterialType::EXAMPLE_MAT_HARDWARE_INSTANCING3:
			{
			std::wstring filePath = L"../Resources/Textures/tex3.dds";
				mat->m_diffuseTex = gTexContainer.CreateTexture(cmdBuffer, filePath);
			}
			break;
