...
class StaticMeshInstancingExample : public ExampleAppBase
{
public:
	StaticMeshInstancingExample(std::wstring appName, int width, int height)
		: ExampleAppBase(appName, width, height)
	{
	}

	virtual ~StaticMeshInstancingExample() {}
...
public:
	...
	XMFLOAT3 m_objectArea = XMFLOAT3(250.0f, 300.0f, 200.0f);
