...
SimpleShader::SimpleShader(ShaderPassStates shaderPassStates)
{
	...
	{
		m_shaderPasses.insert(std::make_pair(EShaderStageType::COMPUTE_SHADER, new ShaderStage("CS", "cs_5_1")));
	}
}
